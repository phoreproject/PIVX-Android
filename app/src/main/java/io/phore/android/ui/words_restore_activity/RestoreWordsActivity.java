...
import io.phore.android.ui.transaction_send_activity.MyTextWatcher;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = phoreModule.getAvailableMnemonicWordsList();
        ...
        if (current < layouts.length) {
            ...
            try {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            ...
                                            phoreModule.restoreWallet(mnemonic, PIVX_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    dialog.setRightBtnTextColor(getColor(R.color.bgGreen));
                }else {
                    dialog.setRightBtnTextColor(ContextCompat.getColor(this, R.color.bgGreen));
                }
                dialog.show();
            } catch (Exception e) {
                e.printStackTrace();
