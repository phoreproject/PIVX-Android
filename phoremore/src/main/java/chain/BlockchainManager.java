...
import org.phorej.core.CheckpointManager;
...
import org.phorej.core.TransactionBroadcast;
...
import org.phorej.net.discovery.MultiplexingDiscovery;
...
//                CrashReporter.saveBackgroundTrace(new RuntimeException(message), application.packageInfoWrapper());
                ...
                // Note: In the future, make this configurable. If the UI ever
                // supports configuring a trusted node, this becomes important
